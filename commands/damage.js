...
if(searchid(message.author.id,searchid(usrserver,users).data).rank==="Admin"){
    ...
    searchid(message.author.id, searchid(usrserver,users).data).hp=searchid(message.author.id, searchid(usrserver,users).data).hp-10;
    
    message.channel.send("Did 10 damage")
