...
module.exports.run = async (client, message, args, prefix,ticks,users,items,locations,mobs,moblist,cooldown,server) => {
  ...
  var user2=searchid(usrserver,users).data
  
  //console.log(user2)
  
 // console.log(searchid(message.author.id,user2).status)
  
message.channel.send(searchid(message.author.id,user2).status)
