...
if(searchid(message.author.id,searchid(usrserver,users).data).rank==="Admin"){
         ...
         searchid(usrserver,locations).data.splice(searchid(usrserver,locations).data.indexOf(searchid(searchid(message.author.id,searchid(usrserver,users).data).location,searchid(usrserver,locations).data)),1)
         
         searchid(message.author.id,searchid(usrserver,users).data).location=0
